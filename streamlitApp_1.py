...
Indicators = ['bvin','hodler_net_position_change','realized_profits_to_value_ratio','investor_capitalization','cvdd','rhodl_ratio', 'balanced_price_usd','difficulty_ribbon_compression',
